            ...
            <form className="space-y-4" onSubmit={handleLogin}>
              <div>
                ...
                <input
                  ...
                  className={`w-full bg-slate-50 border rounded-xl px-4 py-3 text-sm transition-all outline-none
                ${touched.email && errors.email ? "border-red-500" : ""}
                ${touched.email && !errors.email && email ? "border-green-500" : "border-border-light"}`}
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  ${touched.password && !errors.password && password ? "border-green-500" : "border-border-light"}`}
